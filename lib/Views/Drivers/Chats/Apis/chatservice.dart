...
class UserService {
  final String apiUrl =
      "https://fama-logistics-ljza.onrender.com/api/v1/firebaseMessage/viewAllUsers";
  final String sendMessageUrl =
      "https://fama-logistics-ljza.onrender.com/api/v1/firebaseMessage/userSendMessage/";
  ...
  Future<List<Map<String, dynamic>>> fetchChatMessages(String userId) async {
    ...
    final uri = Uri.parse(
        "https://fama-logistics-ljza.onrender.com/api/v1/firebaseMessage/userViewMessage/$userId");
    try {
      final response = await http.get(
        uri,
        headers: {
