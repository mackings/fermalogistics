...
import 'package:getnamibia/Views/Drivers/Pickups/Views/delivery.dart';
...
Future<void> _confirmPickup(BuildContext context, SendOrder upcomingOrder) async {
  ...
  String apiUrl = "https://getnamibia-logistics.onrender.com/api/v1/delivery/deliveryArrived/$orderId";
