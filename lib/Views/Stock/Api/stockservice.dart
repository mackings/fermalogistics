...
import 'package:getnamibia/Views/Stock/Model/category.dart';
...
class ApiService {
  ...
  const url = 'https://fama-logistics-ljza.onrender.com/api/v1/cart/viewAllCategories';
...
Future<List<Product>> fetchProducts() async {
  const url = 'https://fama-logistics-ljza.onrender.com/api/v1/cart/viewAllProducts';
  final token = await retrieveUserData();
  if (token == null) {
    throw Exception('Authorization token not found');
  }
...
Future<List<Product>> fetchProductsByCategory(String categoryName) async {
    ...
    final url = 'https://fama-logistics-ljza.onrender.com/api/v1/cart/searchProductOrCategoryByName/$categoryName';
    final token = await retrieveUserData();
   ...
   Future<List<Product>> fetchProductByName(String productName) async {
    final url = 'https://fama-logistics-ljza.onrender.com/api/v1/cart/searchProductByName/$productName';
    final token = await retrieveUserData();
