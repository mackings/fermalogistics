import 'dart:convert';
import 'package:getnamibia/Views/Stock/Views/checkout/checkout.dart';
  ...
  Future<void> fetchShippingCosts() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            "https://fama-logistics-ljza.onrender.com/api/v1/checkout/calculateShipmentCostForOrder"),
        headers: {
