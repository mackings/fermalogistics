...
import 'package:getnamibia/Views/Product/Model/requests.dart';
import 'package:getnamibia/Views/Product/cardrequestwidget.dart';
import 'package:getnamibia/Views/Product/newrequest.dart';
import 'package:getnamibia/Views/Product/reqstatus.dart';
import 'package:getnamibia/Views/Product/widgets.dart';
...
class _RequestproductState extends ConsumerState<Requestproduct>
  ...
  Future<List<Request>> fetchRequests() async {
    final response = await http.get(
      Uri.parse(
          'https://fama-logistics-ljza.onrender.com/api/v1/request/getAllRequest'),
      headers: {
